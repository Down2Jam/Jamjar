...
type CustomSvgIconProps = React.SVGProps<SVGSVGElement> & { size?: number };

const MacOsIcon: React.FC<CustomSvgIconProps> = ({
  size = 24,
  width,
  height,
  ...props
...
const WindowsIcon: React.FC<CustomSvgIconProps> = ({
  size = 24,
  width,
  height,
  ...props
  ...
  <svg
    ...
    {...props}
  >
    <path d="M1.5 3.4 10.1 2.2v9H1.5V3.4Zm9.7-1.4 11.3-1.6v10.8H11.2V2ZM1.5 12.8h8.6v9L1.5 20.6v-7.8Zm9.7 0h11.3v10.8L11.2 22v-9.2Z" />
  </svg>
);
